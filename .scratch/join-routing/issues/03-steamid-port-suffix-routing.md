...
**Status:** completed（静态闭环 `audit/2026-09-12/Implementation-0.2.4.8-Ticket03-1048.md`；Runtime `audit/2026-09-18/RuntimeAcceptance-0.2.4.8-Ticket03-0105.md`：地址栏整串 `SteamID:27016` → `route=SteamP2P` 进房，用户 2026-09-18 关单）
