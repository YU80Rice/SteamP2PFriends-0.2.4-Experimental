...
namespace SteamP2PFriends.Core.Patches.P0EZombieLifecycle
{
    ...
    public struct ZombieLifecycleState
    {
        ...
        public uint oldRegionGeneration;
        public uint newRegionGeneration;
        public ZombieRegion oldRegionIdentity;
        public ZombieRegion newRegionIdentity;
    }
}
