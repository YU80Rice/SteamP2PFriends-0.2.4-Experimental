...
namespace SteamP2PFriends.Patches.P0EZombieLifecycle
{
    ...
    public static class ZombieLifecyclePatch
    {
            ...
            ref ZombieLifecycleState __state)
        {
            ...
            if (ZombieRegionLifecycleAdapter.IsReady)
            {
                ZombieRegionLifecycleAdapter.BeginLocalTransition(player, oldBound, newBound, ref __state);
                return;
            }
            ...
            ZombieLifecycleState __state)
        {
            if (ZombieRegionLifecycleAdapter.IsReady)
            {
                ZombieRegionLifecycleAdapter.CompleteLocalTransition(player, newBound, ref __state, null);
                return;
            }
            ...
            System.Exception __exception)
        {
            ...
            {
                if (__exception != null)
                    ZombieRegionLifecycleAdapter.CompleteLocalTransition(player, newBound, ref __state, __exception);
                return __exception;
            }
