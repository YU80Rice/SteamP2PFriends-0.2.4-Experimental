...
| 12 Resource Seam 回滚-重试登记一致性（R4+R2） | `2026-09-10/Implementation-0.2.4.8-Ticket12-0027.md`（R4 治本两处补偿 + 过时退出容忍兜底 + R2 静默稳态 + Ticket09 脚本编码修复；红→绿 263/263、四门禁 PASS、双轴 round 1 双 CLEAN；新指纹 BBBDCC25/cdac3a0a，**Runtime 验证归属本票，停等 1H+2G**） | — |
