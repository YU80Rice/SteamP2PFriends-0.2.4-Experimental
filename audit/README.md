...
| 05 共享 1 Host + 2 Guest Runtime 验收 | 待用户三端实机（执行包见 `.scratch/listen-host-join-routing-runtime-acceptance/issues/05-shared-1h2g-runtime-acceptance.md`：候选 A69B78AF、Case 矩阵 C05-01…07、三局编排） | 分析结论将落盘 `RuntimeAcceptance-0.2.4.8-Ticket05-*.md` |
