...
namespace SteamP2PFriends.Patches
{
    ...
    public static class ItemManagerRegionSyncPatch
    {
        ...
        public static bool RegisterManual(Harmony harmony)
        {
            ...
            RoleLogger.Info("[Shared]", "[ItemRegionSync] === M1 登记组合 Transpiler + askItems Prefix ===");
            ...
            RegistrationSummary = $"signature={SignatureResolved}, sendReplacement=1/1, generationReplacement=1/1, askItemsPrefix=true, " +
            ...
            IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            RoleLogger.Info("[Shared]",
                "[ItemRegionSync] OK Transpiler send=1/1 generation=1/1; native generate precedes loaded commit and askItems");
            return codes;
        }
