...
namespace SteamP2PFriends
{
    ...
    /// </summary>
    [BepInPlugin("com.yu80rice.steamp2pfriends", "SteamP2PFriends", "0.2.4.3")]
    ...
    public class SteamP2PFriendsPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            RoleLogger.Info("[Shared]",
                $"[Startup] version=0.2.4.3 architecture=M3-zombie-region-lifecycle p2pEnabled={EnableP2PCoop.Value} " +
