        ...
        private static readonly IReadOnlyList<ModuleOwnershipRecord> _records =
            new ReadOnlyCollection<ModuleOwnershipRecord>(new List<ModuleOwnershipRecord>
            {
                ...
                new ModuleOwnershipRecord("Adapters.Zombie", ModuleOwnershipKind.DomainAdapter,
                    ...
                    "U3-REG-05-WorldSyncAndAdapters", string.Empty),
                new ModuleOwnershipRecord("Adapters.Animal", ModuleOwnershipKind.DomainAdapter,
                    "Adapters/Animal", "AnimalDomainAdapter",
                    "U3-REG-05-WorldSyncAndAdapters", string.Empty),
                new ModuleOwnershipRecord("Adapters.Structure", ModuleOwnershipKind.DomainAdapter,
                    "Adapters/Structure", "BuildingDomainAdapter",
                    "U3-REG-05-WorldSyncAndAdapters", string.Empty),
                new ModuleOwnershipRecord("Adapters.Barricade", ModuleOwnershipKind.DomainAdapter,
                    "Adapters/Structure", "BuildingDomainAdapter",
                    "U3-REG-05-WorldSyncAndAdapters", string.Empty),
                new ModuleOwnershipRecord("Adapters.Vehicle", ModuleOwnershipKind.ControlledCrossDomain,
                    "Core/Patches", "PendingVehiclePatchSet",
                    "U3-REG-05-WorldSyncAndAdapters;U3-REG-06-Probes",
                    "Pending：Vehicle 同时覆盖世界同步、交互诊断和原生生命周期，当前尚无可证明的单一领域适配器边界；保留在 Core/Patches。"),
                new ModuleOwnershipRecord("Adapters.Object", ModuleOwnershipKind.ControlledCrossDomain,
                    "Core/Patches", "PendingObjectPatchSet",
                    "U3-REG-05-WorldSyncAndAdapters",
                    "Pending：Object 当前由 ObjectManager 区域同步、世界诊断和二进制状态观察共同覆盖，尚无可证明的单一领域适配器边界；保留在 Core/Patches。"),
                new ModuleOwnershipRecord("Adapters.OtherPending", ModuleOwnershipKind.ControlledCrossDomain,
                    "Core/Patches", "PendingOtherDomainPatchSet",
                    "U3-REG-02-InternalDiagnostics;U3-REG-04-AssetAndAudit;U3-REG-06-Probes",
                    "Pending：其余跨领域诊断/审计补丁尚未能由源码证明单一领域归属，保留在 Core/Patches。"),
